...
def draw_hud():
    ...
    try:
        ...
        print(f"[HUD Error] Failed to get shader: {e}")
        return
    ...
    try:
        ...
        print(f"[HUD Error] Failed drawing Background: {e}")

    cx, cy = x + size/2, y + size/2
    
    # 2. Points drawing inner Joystick grid
    if group and hasattr(group, 'shape_xy_list'):
        try:
            ...
            print(f"[HUD Error] Failed drawing mapping points: {e}")

    # 3. Main Joystick lines and Target Dot
    try:
    ...
    try:
        ...
        print(f"[HUD Error] Failed drawing Buttons/Boxes: {e}")
    ...
    try:
        ...
        print(f"[HUD Error] Failed drawing Button Texts: {e}")
